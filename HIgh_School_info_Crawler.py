...
class SchoolCrawler(object):
    ...
    '''
    def __init__(self,file_path, web_drive_name='Chrome', web_drive_wait_time=5):
    ...
    def County_List(self,state_path):
        ...
        '''Instance Variables'''
        root_path = self.root_path_private
    ...
    def Public_School_list(self,pbs_rows,schools_page, public_sheet):
        ...
        '''Instance Variables'''
        root_path = self.root_path_public
        web_drive_name = self.web_drive_name
        web_drive_wait_time = self.web_drive_wait_time

        '''Public School'''
        #print(root_path+schools_page+"/public")
        sub_public_request = urllib.request.Request(root_path+schools_page)
        ...
        for pbs in public_schools_list:
            ...
            '''Some school's link contains root link'''
            url = root_path + current_pbs_link
